...
export default function TechStacks() {
  return (
    <section className="flex flex-col items-center justify-center mx-5 my-10">
      <div className="flex flex-col items-center my-5 py-5 text-white">
        <p className="text-3xl mx-3 txtcolor font-bold mb-10">TECH STACKS</p>
        <div className="justify-center items-center">
          ...
          <img src="https://skillicons.dev/icons?i=vscode,windows,python,html,css,js,ts,nodejs,npm,tailwind,react,vite,firebase,postgresql,sqlite,mysql,git,github,postman,figma,markdown,jest,sklearn&theme=dark&perline=10" />
        </div>
      </div>
    </section>
  );
